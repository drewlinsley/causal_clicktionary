...
def get_synset_map():
    ...
    for i, l in enumerate(synset):
        ...
        synset_map += [{"desc": desc, "synset": label, "index": i}]
    return synset_map
...
def get_idx_from_file(f):
    synset_map = get_synset_map()
    return [s['index'] for s in synset_map if s['synset'] == f]


def get_name_from_file(f):
    synset_map = get_synset_map()
    return [s['desc'] for s in synset_map if s['synset'] == f]
